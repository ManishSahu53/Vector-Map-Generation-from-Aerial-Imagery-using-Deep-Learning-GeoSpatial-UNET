...
"""
from src.model.util import layers as custom_layers
from src.model.models import Network
...
class DeepLabV3(Network):
    def __init__(self, num_classes, version='DeepLabV3', base_model='ResNet50', **kwargs):
        ...
        assert base_model in ['VGG16',
                              ...
                              'MobileNetV2',
                              'Xception-DeepLab']
        super(DeepLabV3, self).__init__(num_classes,
                                        version, base_model, dilation, **kwargs)
    ...
    def _deeplabv3(self, inputs):
        ...
        x = self._conv_block(x, 3, [512, 512, 2048],
                             stage=5, block='a', dilation=dilation[1])
        for i in range(2):
